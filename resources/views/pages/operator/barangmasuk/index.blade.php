...
<div class="d-flex align-items-center justify-content-between">
    <a href="{{ route('barangmasuk.create') }}" class="btn btn-primary" style="margin-top:15px;">Tambah</a>
</div>
<hr />
...
@endif
<h2 style="margin-bottom:15px;">Barang Masuk</h2>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a style="margin-right:10px" href="{{ route('barangmasuk.edit', $rs->id_masuk)}}" type="button" class="btn btn-warning">Edit</a>
